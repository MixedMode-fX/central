...
function PadFields(app, where, pad, set) {
  ...
  if (pad.kind === PadKind.PROGRAM) return el('div', {}, Fields(...fields), Launch(app, pad, set));
  fields.push(Field({ label: 'on channel' }, ChannelField(pad.channel, (channel) => set({ channel }))));
