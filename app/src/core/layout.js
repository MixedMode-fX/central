...
import { renumberNodeKeys } from './patch.js';
...
// The same rule the bindings, the routes and the drum voices follow.
export function forgetNode(saved, index) {
  return Object.fromEntries(renumberNodeKeys(Object.entries(saved ?? {}), index));
}
