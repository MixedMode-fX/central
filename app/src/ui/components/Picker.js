...
//
// This is the widget, and it knows nothing about algorithms: what goes in it
// is `core/catalogue.js`, which is arithmetic on the device's own descriptors
// and is tested with no browser in the room.

import { el } from '../dom.js';
import { optionsOf, optionFor, filterGroups } from '../../core/catalogue.js';
import './Picker.css';
...
// panel goes with it.
export function Picker({ value, groups, onPick, label, empty = 'nothing to add' }) {
