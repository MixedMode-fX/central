...
// this module has N_NODE x N_PARAM = 15456 parameters before the clock and
...
// second lookup table:
//
//   0x0000 .. 0x3C5F   a node's parameter.
//                      node  = address / N_PARAM
//                      param = address % N_PARAM
//                      (N_NODE * N_PARAM = 46 * 336 = 15456 = 0x3C60)
//   0x3C60 .. 0x3C6F   the master clock: address - 0x3C60 is a CcClockTarget.
//   0x3C70 .. 0x3C7F   the transport: address - 0x3C70 is a CcTransportTarget.
//   0x3C80 .. 0x3C8F   the key: address - 0x3C80 is a CcKeyTarget.
...
// read as an address in the wrong block. A host that takes N_NODE from the
// capability message and multiplies computes the same numbers this header
// states rather than hardcoding them.
//
...
#define NRPN_CLOCK_BASE     0x3C60u
#define NRPN_TRANSPORT_BASE 0x3C70u
#define NRPN_KEY_BASE       0x3C80u
#define NRPN_RESERVED_BASE  0x3C90u
